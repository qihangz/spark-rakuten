...
"""
The index in the given dataset is not continuous because of some missing values. Map them into continuous numbers so that it's easier to store in matrix.
The inverse option is to convert it back.
"""
...
def sortPoint(line):
"""
Parse each line, remove the duplicates and sort the values
"""
...
def get_CPIR(line):
"""
Calculate CPIR and cooccurrence at the same time
"""
	parts = line[0].split('|')
	count = line[1]
...
"""
Calculate the probability of each index first.
"""
...
"""
Load the real genres' name in the dictionary
"""
